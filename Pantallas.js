...
var CharacterSelect = new Phaser.Class({
    ...
    create: function(){
        ...
        player1T = document.getElementById("namebar").value;
        //Nombre jugador 2:
        ...
        //Barra nombre personajes
        function introduceName(){
            let input = document.getElementById('namebar');

            if(input == null) player1T.setText('Player1');
            else player1T = document.getElementById('namebar').value;
        }
        //Interaccion nombres:
        //Jugador1:
        document.getElementById("namebar").addEventListener("onkeyup", ()=>{
            introduceName();
        })
        /*
        ...
        this.aceptar1.on("pointerdown", ()=>{
            ...
            if(document.getElementById('namebar').value == 'Introduce tu nombre:'){
                document.getElementById('namebar').value = "Player1";
                player1T = document.getElementById('namebar').value;
            }
            this.ready1 = 1;
            console.log(player1T);
        })
